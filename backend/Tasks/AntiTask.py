...
class AntiTask(Task):
  ...
  def __init__(self, task_id, title, description, start_time, duration, start_date, cancelled_task_id):
    ...
    super().__init__(task_id, title, description, "anti", start_time, duration, start_date)
