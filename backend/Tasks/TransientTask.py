...
class TransientTask(Task):
  ...
  def __init__(self, task_id, title, description, start_time, duration, start_date, date_time):
    # super calls the __init__ method of the parent class Task to initialize the task
    super().__init__(task_id, title, description, "transient", start_time, duration, start_date, date_time)
